        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('dosis')
                    ->maxLength(255)
                    ->default(null),
                Forms\Components\DatePicker::make('tanggal_minum'),
                Forms\Components\TextInput::make('jam_minum'),
            ]);
    }
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('dosis')
                    ->searchable(),
                Tables\Columns\TextColumn::make('tanggal_minum')
                    ->date()
                    ->sortable(),
                Tables\Columns\TextColumn::make('jam_minum'),
